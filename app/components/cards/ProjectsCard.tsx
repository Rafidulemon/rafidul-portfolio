...
function ProjectsCard(props: ProjectsCardProps) {
  ...
  return (
    <div className="relative bg-[#111111] rounded-2xl shadow-md shadow-cyan-900 flex flex-col overflow-hidden">
      {/* Image Section */}
      ...
      <div className="flex flex-col w-full p-4">
        ...
        <div className="md:hidden flex-col items-center justify-center gap-4 mt-4">
          <Text
            ...
            className="text-[#ADB7BE] text-center text-[14px] md:text-[16px]"
          />
          <div className="w-full flex flex-row items-center justify-center gap-6 mt-4">
            <a
              ...
              className="text-cyan-500 text-[20px] hover:text-white transition"
            >
              <FaGithub />
            </a>
            <a
      ...
      <div className="absolute inset-0 bg-black bg-opacity-90 opacity-0 hover:opacity-100 md:flex md:opacity-0 hidden flex-col items-center justify-center gap-4 p-4">
        <Text
          text={project_details}
          className="text-[#ADB7BE] text-center text-[14px] md:text-[16px]"
        />
