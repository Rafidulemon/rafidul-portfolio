    ...
    <div className="flex flex-col p-10 rounded shadow-lg shadow-teal-700 gap-10  bg-black dark:bg-white">
      ...
      >
        <Text
          ...
          isBold
          className="text-[16px] md:text-[18px] lg:text-[22px] xl:text-[24px] dark:text-primary_dark text-cyan-500"
        />
        <div className="flex flex-col gap-2 md:gap-3 lg:gap-4">
          <Link href={"https://bc-bangladesh.com/"}>
            <Text
              text="Brand Cloud Inc. Bangladesh"
              className="text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px] dark:text-primary text-cyan-200"
              isBold
            />
          </Link>
          <Text
            text="From August 2023 to Present"
            className="dark:text-gray-700 text-white text-[10px] md:text-[12px] lg:text-[13px] xl:text-[14px]"
          />
        </div>
        ...
        <div className="flex flex-col gap-2 md:gap-3 lg:gap-4">
          ...
          <Text
            ...
            className="text-[11px] md:text-[13px] lg:text-[15px] xl:text-[16px] dark:text-gray-700 text-cyan-200 -mt-2"
          />
          <Text
